...
const PropertyDetailPage = () => {
    ...
    const handleContact = () => {
        ...
        const url = `https://wa.me/${process.env.EXPO_PUBLIC_ADMIN_PHONE_NUMBER}?text=${encodeURIComponent(message)}`;
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            console.error(
                                "Error marking property as sold:",
                                (error as Error)?.message,
                            );
                            Alert.alert(
                                "Error",
                                "Failed to mark property as sold. Please try again.",
                            );
                        }
                    },
                    style: "destructive",
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View>
                    ...
                    <View className="absolute bottom-3 right-4 bg-black/50 px-3 py-1 rounded-full">
                        <Text className="text-white text-sx font-medium">
                ...
                >
                    ...
                    <Text className="text-gray-500 text-sm leading-6 mt-1">
                        {displayDesc}
                    </Text>
                    {isLongDesc && (
                        <TouchableOpacity
                            ...
                            className="mt-2"
                        >
                            <Text className="text-blue-600 font-medium text-sm mb-5">
                    ...
                    <TouchableOpacity
                        className="flex-row items-center justify-center gap-2 bg-green-500 py-4 rounded-2xl mb-4"
                    ...
                    {isAdmin && (
                        <View className="flex-row gap-3">
                            {!property?.is_sold && (
                                <TouchableOpacity
                                    className="flex-1 flex-row items-center justify-center gap-2 bg-amber-50 rounded-2xl border border-amber-200 py-4"
                            ...
                            <TouchableOpacity
                                className="flex-1 flex-row items-center justify-center gap-2 bg-red-50 rounded-2xl border border-red-200 py-4"
