        ...
        <SafeAreaView className="flex-1 bg-gray-50">
            <View className="px-5 pt-4 pb-3">
                ...
                <View className="flex-row gap-3 items-center">
                    <View
                        className="flex-1 flex-row items-center gap-3 bg-white rounded-2xl px-4"
                        style={{
                            shadowColor: "#000",
                    ...
                    <TouchableOpacity
                        className={`w-12 h-12 rounded-2xl items-center justify-center ${activeFilterCount > 0 ? "bg-blue-500" : "bg-white"}`}
                        style={{
                            shadowColor: "#000",
                            shadowOffset: { width: 0, height: 1 },
                            shadowOpacity: 0.06,
                    ...
                    >
                        <Ionicons
                            ...
                            size={20}
                            color={activeFilterCount ? "#fff" : "#374151"}
                        />
                        {activeFilterCount > 0 && (
                ...
                ListEmptyComponent={
                    !loading ? (
                        <View className="py-10 items-center">
                            <Text className="text-gray-400">No properties available.</Text>
